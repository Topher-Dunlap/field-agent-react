    ...
    return (
        <div className="container">
            ...
            <main>
                <article>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ornare diam neque. Cras semper
                        nisi sed
                        ante placerat pulvinar. Nunc lacinia, ante nec tristique hendrerit, mauris est accumsan
                        ante,
                        non
                        bibendum arcu libero et neque. Cras consequat neque tristique quam pretium, eget rutrum
                        ligula
                    ...
                    <p>Sed euismod pretium purus. Pellentesque habitant morbi tristique senectus et netus et
                        malesuada
                        fames ac
                        turpis egestas. Nunc id odio tortor. Ut vulputate id diam vel vestibulum. Proin sed porta
                        purus.
                        Etiam
            ...
            <aside>
                ...
                <p>Aliquam maximus augue in lacus tincidunt semper. Mauris a felis lectus. Proin lacinia massa id
                    mauris
